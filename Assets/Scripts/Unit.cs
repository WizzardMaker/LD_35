...
Zuzana";
		...
		public SpecialInfos(Extra[] extras) {
			string[] lines = names.Split(new string[] { System.Environment.NewLine }, System.StringSplitOptions.None);
			name = lines[Random.Range(0, lines.Length)];
			this.extras = extras;
	...
	public void MakeTarget() {
		...
		/*
		Extra[] extra = (from ex in extras
						 where (Random.Range(0, 100) < 35 && i++ < 3) || extras.Length - i <= 1
						 select ex).ToArray();

		Debug.Log(i + "/" + extra.Length);
		*/
